...
class Movie(Model):
    ...
    def __init__(self, id=None, name=None, synopsis=None, directors=None, writers=None, duration=None, tags=None, genres=None, release_date=None, characters=None, rating=None):  # noqa: E501
