...
from swagger_server.models.anime_name import AnimeName  # noqa: F401,E501
...
class Anime(Model):
    ...
    def __init__(self, name: AnimeName=None, format: str=None, tags: List[str]=None, genres: List[str]=None, synopsis: str=None, season: str=None, duration: int=None, release_date: date=None, studios: List[str]=None, episodes: int=None, source: str=None, characters: List[Character]=None, rating: float=None):  # noqa: E501
        """Anime - a model defined in Swagger
    ...
    @studios.setter
    def studios(self, studios: List[str]):
